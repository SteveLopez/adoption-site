...
class InquiriesControllerTest < ActionController::TestCase
  ...
  test "should create inquiry" do
    assert_difference('Inquiry.count') do
      post :create, inquiry: { child_id: @inquiry.child_id, client_id: @inquiry.client_id, message: @inquiry.message }
    end
  ...
  test "should update inquiry" do
    put :update, id: @inquiry, inquiry: { child_id: @inquiry.child_id, client_id: @inquiry.client_id, message: @inquiry.message }
    assert_redirected_to inquiry_path(assigns(:inquiry))
  end
